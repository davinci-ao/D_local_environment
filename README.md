...
## Installation
- Make sure you have docker AND docker compose installe (easiest way to do this is to install docker desktop - [Download Docker Desktop]([Download Docker Desktop](https://www.docker.com/products/docker-desktop)) )
